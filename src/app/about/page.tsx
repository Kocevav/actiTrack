...
const AboutPage = () => {
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-900 via-neutral-950 to-black p-4">
      <div
        className="
          relative z-10 w-full max-w-3xl px-4 py-10 
